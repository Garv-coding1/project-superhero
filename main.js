...
function up() {
    if (player_y >0) {
        ...
        console.log("When up arrow key pressed Player X = " + player_x + ", Y = " + player_y);
...
function down() {
    if (player_y <= 570) {
        player_y = player_y + block_height;
        console.log("Block Image Height is " + block_height);
        console.log("When down arrow key pressed Player X = " + player_x + ", Y = " + player_y);
        canvas.remove(player_object);
        player_update();
    }
}
...
function left() {
    if (player_x >0) {
        ...
        console.log("When left arrow key pressed Player X = " + player_x + ", Y = " + player_y);
        canvas.remove(player_object);
        player_update();
    }
}
...
function right() {
    if (player_x <= 870 ) {
        player_x = player_x + block_width;
        console.log("Block Image Width is " + block_width);
        console.log("When right arrow key pressed Player X = " + player_x + ", Y = " + player_y);
        canvas.remove(player_object);
        player_update();
    }
}
